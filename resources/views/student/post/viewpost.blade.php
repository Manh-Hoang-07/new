        ...
        <tbody>
          ...
          <tr>
            ...
            @elseif($quantityUserPosts[$i][$post->id] >= $post->quantity)
                ...
                @else
                    <td><a style="color: #2fad5b;" href="{{route('student.register',['user_id'=>\Illuminate\Support\Facades\Auth::user()->id,'post_id'=>$post->id])}}"><i class="fa fa-check text-success text-active"></i> Đăng ký</a></td>
            @endif
          </tr>
          @php
            $i++;
